...
//	and has its own implementation of  calculateSalePrice() method
...
//	if length of sedan is >20 feet then returned car price
//	should include 5% discount, otherwise 10% discount

		public static void main(String[] args) {
			
			Car sedan = new Sedan(10000.0,"White",30);
			System.out.println(sedan.calculateSalePrice());
			Car truck = new Truck(20000.0,"Blue",3000);
