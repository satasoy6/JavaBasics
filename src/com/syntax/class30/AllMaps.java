...
public class AllMaps {
	...
	public static void main(String[] args) {
		...
		Iterator<String> it=shopping.keySet().iterator();//Who has access to the iterator ? -My collection.
		while(it.hasNext()) {							//shopping.keySet().iterator(); this is method chaining
